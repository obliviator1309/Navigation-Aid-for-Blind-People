...
cap = cv2.VideoCapture("/home/fizzing/AI/minor2/project2/navigation_blind/Code/challenge.mp4")
...
def run(screen):
	...
	try:
		...
		if not (results is None):
			if (results[0] > 400):
				with open("/home/fizzing/AI/minor2/project2/navigation_blind/Code/write.txt","a") as f:
					f.write("Turn Left")
			else:
				with open("/home/fizzing/AI/minor2/project2/navigation_blind/Code/write.txt","a") as f:
					f.write("Turn Right")
...
while True:
	try:
		...
		#screen = imutils.rotate_bound(screen,90)
	except:
		with open("/home/fizzing/AI/minor2/project2/navigation_blind/Code/write.txt","a") as f:
			f.write("Done")
